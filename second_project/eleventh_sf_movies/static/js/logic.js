...
var link1 = "static/data/sf_movies.geojson";
var link2 = "static/data/sf_crime.geojson"
var man = []
...
function makeMyMap(error, movies, nyc_yelp)  {
  console.log(movies);
  console.log(nyc_yelp);
  test_data = movies
  var moviesGeoJsonMap = L.geoJson(movies, {
    ...
    onEachFeature: function (feature, layer) {
      var popupText = "<h5>" + "<a href=\"" + feature.properties.site + "\""+" target=\"_blank\">" + feature.properties.film_year + "</a></h5> <hr> <h5>" + feature.properties.location + "</h5><h5>" + feature.properties.genre + "</h5> <h5>" + feature.properties.plot + "</h5> <h5> Rated: " + feature.properties.rated + " ,     Ratings: " + feature.properties.rating + "<h5>" 
